            ...
            <address className="not-italic space-y-4">
              <div className="flex gap-3">
                ...
                <div className="font-body text-sm text-cream/65 leading-relaxed">
                  ...
                  <span className="block">{SITE.address.city}, {SITE.address.state} {SITE.address.zip}</span>
                </div>
              </div>
      ...
      <div className="border-t border-cream/10">
        <div className="max-w-8xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-body text-xs text-cream/35 tracking-wide">
            ...
            <a href={SITE.parent.url} className="hover:text-cream/60 transition-colors">
              FIDI Hospitality
            </a>{" "}
            venue.
          </p>
          <div className="flex gap-6">
            <Link href="/sitemap" className="font-body text-xs text-cream/35 hover:text-cream/60 transition-colors tracking-wide">
              Site Map
            </Link>
            <Link href="/privacy" className="font-body text-xs text-cream/35 hover:text-cream/60 transition-colors tracking-wide">
              Privacy Policy
            </Link>
          </div>
        </div>
